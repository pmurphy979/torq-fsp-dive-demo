...
.dive.trigger:{[funcname;triggername;overrides]
  ...
  neg[h](`.dive.triggerrules;.proc.procname;funcname;triggername;overrides);
  1b
  }
...
.dive.triggerevent:{[funcname;triggername;overrides]
